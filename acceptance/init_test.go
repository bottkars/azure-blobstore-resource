...
var _ = BeforeSuite(func() {
	...
	pathToCheck, err = gexec.Build("github.com/bottkars/azurestack-blobstore-resource/cmd/check")
	Expect(err).NotTo(HaveOccurred())

	pathToIn, err = gexec.Build("github.com/bottkars/azurestack-blobstore-resource/cmd/in")
	Expect(err).NotTo(HaveOccurred())

	pathToOut, err = gexec.Build("github.com/bottkars/azurestack-blobstore-resource/cmd/out")
	Expect(err).NotTo(HaveOccurred())
